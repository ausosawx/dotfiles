...
source ~/.config/shell/plugins/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh
source ~/.config/shell/plugins/zsh-autosuggestions/zsh-autosuggestions.zsh
...
if [[ "$(tput colors)" == "256" ]]; then
    eval $(dircolors =(cat ~/.config/shell/plugins/dircolors-solarized/dircolors.256dark $ZDOTDIR/dircolors.extra))
fi
